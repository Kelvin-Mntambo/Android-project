...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            case R.id.gratitude:
         startActivity(new Intent(MainActivity.this,Gratitude_activity.class));
                break;
            case R.id.feedback:startActivity(new Intent(MainActivity.this,Feedback_activity.class));

                break;
            case R.id.Setting: startActivity(new Intent(MainActivity.this,Settings_activity.class));
